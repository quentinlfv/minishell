...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2023/05/20 16:51:42 by nasamadi          #+#    #+#              #
#    Updated: 2023/06/29 14:54:17 by nasamadi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_BUILTIN =	cd.c				echo.c				env.c				\
				...
				unset.c				cd_error.c			export_utils1.c		\
				cd_utils1.c			unset_utils.c		export_utils2.c	
